...
import tw.edu.ntut.csie.game.state.ReadyInterface_1;
import tw.edu.ntut.csie.game.state.ReadyInterface_2;
import tw.edu.ntut.csie.game.state.ReadyInterface_3;
...
public class Game extends Activity {
    ...
    public static final int Level_1_Ready = 3 ;
    public static final int Level_2_Ready = 4 ;
    public static final int RUNNING_STATE2 = 5 ;
    public static final int Level_3_Ready = 6;
    public static final int RUNNING_STATE3 = 7;
    public static final int OVER_STATE = 8;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!_view.isInEditMode()) {
            ...
            _engine.registerGameState( Level_1_Ready, new ReadyInterface_1(_engine) );
            _engine.registerGameState( Level_2_Ready, new ReadyInterface_2(_engine) );
            _engine.registerGameState( RUNNING_STATE2, new StateRun2(_engine) );
            _engine.registerGameState( Level_3_Ready, new ReadyInterface_3(_engine) );
